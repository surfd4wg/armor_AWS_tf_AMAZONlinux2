...
sudo yum update -y
sudo yum install -y https httpd-tools mod_ssl
...
#NEWprivatehostname="AMAZONlinux2-$PRIVATE_IP-$AVAIL_ZONE"
#NEWpublichostname="AMAZONlinux2-$PUBLIC_IP-$AVAIL_ZONE"
...
VarPRI="AMAZONlinux2-$PRIVATE_IP-$AVAIL_ZONE"-"$INSTANCE_ID"
VarPUB="AMAZONlinux2-$PUBLIC_IP-$AVAIL_ZONE"-"$INSTANCE_ID"
